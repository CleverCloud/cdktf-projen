...
```typescript
import { cellarBucket } from '@clevercloud/cdktf-bindings'

new cellarBucket.CellarBucket(scope: Construct, id: string, config: CellarBucketConfig)
```
...
cellarBucket.CellarBucket.isConstruct(x: any)
```
...
cellarBucket.CellarBucket.isTerraformElement(x: any)
```
...
cellarBucket.CellarBucket.isTerraformResource(x: any)
```
...
cellarBucket.CellarBucket.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucket.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly cellarIdInput: string;
```
...
```typescript
public readonly cellarId: string;
```
...
const cellarBucketConfig: cellarBucket.CellarBucketConfig = { ... }
```
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucketConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucketConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucketConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@clevercloud/cdktf-bindings.cellarBucket.CellarBucketConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
